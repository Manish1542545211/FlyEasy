...
import { MapPin, Calendar, Users, ArrowRightLeft, Search, PlaneTakeoff, PlaneLanding } from 'lucide-react';

export default function FlightSearchForm({ onSearch, initialFrom = 'JFK', initialTo = 'CDG' }) {
